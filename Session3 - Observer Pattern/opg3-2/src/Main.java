public class Main
{
  public static void main(String[] args) throws InterruptedException
  {
    ...
    //Adding pedestrians:
    trafficLight.addPedestrians(pedestrian1);
    trafficLight.addPedestrians(pedestrian2);
    trafficLight.addPedestrians(pedestrian3);
    trafficLight.addPedestrians(pedestrian4);
